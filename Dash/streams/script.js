const store = new Vuex.Store({
  state: {
    // initial state
    servers: [
    { name: 'Mr. Ken', status: true, adr: '192.168.0.24' },
    { name: 'Ms. Wambugu', status: true, adr: '192.168.0.25', type: 'database' },
    { name: 'Mr. Kinuthia', status: true, adr: '192.168.0.26', type: 'database' },
    { name: 'Mr. Olesapit', status: true, adr: '192.168.0.37' },
    { name: 'Mrs. Kiragoi', status: true, adr: '192.168.0.17' },
    { name: 'Mrs. Chelagat', status: true, adr: '192.168.0.23' },
    { name: 'Mr. Chirstopher', status: true, adr: '192.168.0.47' },
    { name: 'Mrs. Dorothy', status: true, adr: '192.168.0.127' }] },
